            ...
            <div className="min-h-screen bg-white px-6 py-10">
                <div className="max-w-3xl mx-auto">
                    ...
                    <div className="flex flex-col items-center py-4 mb-6 bg-gray-50">
                        ...
                        {infoSection("Session Info", [
                            { label: "Session Year", value: "2025-2026" },
                            { label: "Education Type", value: "Undergraduate" },
                            { label: "Course", value: "B.Tech" },
                            { label: "Subject", value: "Computer Science" },
                            { label: "Additional Subject", value: "IT" },
                        ])}
...
export default CollegeFormReviewPage;
