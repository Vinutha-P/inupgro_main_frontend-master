...
const UploadMarksList = () => {
    const initialClasses: ClassItem[] = [{ id: 1, className: "Class 10th", required: true }];
    ...
    const handleAdd = () => {
        const nextClassNumber = 10 + markLists.length;
        if (nextClassNumber > 12) return;

        const suffix = nextClassNumber === 11 ? "th" : nextClassNumber === 12 ? "th" : "th";
        const className = `Class ${nextClassNumber}${suffix}`;
