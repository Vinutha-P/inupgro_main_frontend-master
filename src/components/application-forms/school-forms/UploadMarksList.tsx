...
const UploadMarksList = () => {
    ...
    const maxClasses = 12;
    const canAddMore = markLists.length < maxClasses;
            ...
            <div className="border border-gray-200 rounded-lg py-2">
                ...
                <div className="flex justify-center">
                    <button
                        ...
                        onClick={handleAdd}
                        disabled={!canAddMore}
                        className={`mt-2 text-darkBlue font-semibold text-xs flex items-center gap-1 ${canAddMore ? "hover:underline" : "opacity-50 cursor-not-allowed"
                            }`}
