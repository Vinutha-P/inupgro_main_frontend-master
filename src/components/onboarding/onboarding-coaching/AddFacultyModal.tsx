...
const AddFacultyModal = ({
    ...
    onAddFaculty: (faculty: typeof formData) => void;
    ...
    const handleSubmit = () => {
        ...
        if (isValid) {
            onAddFaculty(formData); // Add to parent list
            setFormData({
                fullName: "",
                age: "",
                designation: "",
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-30 flex justify-center items-center z-50">
            <div className="bg-white rounded-xl w-full max-w-2xl p-4 relative shadow-lg">
                ...
                <h3 className="text-[0.6rem] font-bold text-deepBlue mt-5">Faculty Info</h3>
                ...
                <div className="mt-6 flex flex-col md:flex-row gap-3">
                    ...
                    <div className="w-full md:w-[60%] grid grid-cols-1 md:grid-cols-2 gap-3">
                        {[
                            ...
                            <div key={name}>
                                <label htmlFor={name} className="text-[0.6rem] font-semibold text-deepBlue">
                                    {label}
                                </label>
                                <input
                                    id={name}
                                ...
                                />
                                {(name === "fullName" || name === "age") && errors[name] && (
