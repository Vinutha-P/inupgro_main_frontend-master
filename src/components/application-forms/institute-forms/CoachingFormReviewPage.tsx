...
const CoachingFormReviewPage = ({
    ...
    return (
        <div className="bg-white rounded-md shadow-lg w-[100vw] max-w-4xl relative max-h-[90vh] overflow-y-auto p-6">
                ...
                <div className="max-w-3xl mx-auto">
                    ...
                    <div className="flex flex-col items-center py-4 mb-6 bg-gray-50">
                        ...
                        {infoSection("Additional Info", [
                            { label: "Current Education", value: "In 12th Class" },
                            { label: "Course Name", value: "IIT Main" },
                            { label: "Course Medium", value: "English" },
                            { label: "Date of Joining", value: "12th March 2024" },
                        ])}
            ...
            {isModalOpen && (
                <SuccessfulSubmission onClose={handleModalClose} show={isModalOpen} name={""} />
            )}
        </div>
    );
};

export default CoachingFormReviewPage;
